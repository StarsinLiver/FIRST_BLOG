...
function UserBoardList() {
  ...
  let [render2, setRender2] = useState<boolean>(false);
  ...
  if (!render) {
    return (
      <div>
        ...
        {/* 메인 본문의 시작 */}
        <div className="mt-5">
        <SideBar img={sunrise} name={user.name} descript={user.descript} userId={user.userId}/>
  ...
  return (
    <div>
      ...
      <div className="mt-5">
        {/* 얘가 w-25 차지하고 있음 */}
        <SideBar img={sunrise} name={user.name} descript={user.descript} />
        <div className="w-75 float-end">
          <div className="pt-5 me-3 border rounded">
            {/* 메인 본문의 시작 */}
            <div className="w-75 mx-auto mt-5">
