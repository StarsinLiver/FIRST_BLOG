...
DROP SEQUENCE SQ_NEIGHBOR;
CREATE SEQUENCE SQ_NEIGHBOR START WITH 1 INCREMENT BY 1;

DROP TABLE BOARD CASCADE CONSTRAINT;
DROP TABLE BOARD_USER CASCADE CONSTRAINT;
DROP TABLE NEIGHBOR CASCADE CONSTRAINT;
...
(
    NID              NUMBER(5) NOT NULL
        CONSTRAINT PR_NEIGHBOR PRIMARY KEY,
    USER_ID          NUMBER(5),
    NEIGHBOR_USER_ID NUMBER(5),
    INSERT_TIME      VARCHAR2(255),
    UPDATE_TIME      VARCHAR2(255),
    DELETE_YN        VARCHAR2(3),
    DELETE_TIME      VARCHAR2(255),
    CONSTRAINT FK_NEIGHBOR FOREIGN KEY (USER_ID)
        REFERENCES BOARD_USER (USER_ID)
);
